...
def search_company(schlagwoerter='uniper', schlagwortOptionen='2', ergebnisseProSeite=100, debug=True):
    args = argparse.Namespace(
        debug=True, force=True, schlagwoerter='uniper', schlagwortOptionen='1')
